...
|---|---|---|---|
|10|Management|192.168.10.0/24|UDM-SE, Switch, pve-prod-01, pve-prod-02, nas-prod-01 mgmt interface (onboard 2.5GbE)|
|20|Trusted|192.168.20.0/24|Personal laptops, phones, trusted client devices|
|30|Services|192.168.30.0/24|All VMs, LXCs, pi-prod-01, nas-prod-01 data/NFS interface (X710 Port 2)|
...
- **Hosts:** UDM-SE (10.1), Switch (10.2), pve-prod-01 (10.11), pve-prod-02 (10.12), nas-prod-01 mgmt (10.10)

### VLAN 20 — Trusted

- **Outbound allowed to:** Services (30) — any port; Management (10) — TCP 443, 8006, 22 only; Internet — any
- **Outbound denied to:** IoT (40) — no reason to initiate to IoT devices
...
- **Hosts:** All VMs and LXCs (192.168.30.10–.15+), pi-prod-01 (30.20), nas-prod-01 NFS interface (30.16)
...
- Use Network Groups for cleaner rules: define `VLAN30_SUBNET` = 192.168.30.0/24, etc.
