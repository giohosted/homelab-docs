...
_Living document — update as phases complete_
...
|.gitignore|.env files, /opt/appdata, any file matching _secret_ or _password_|
...
_Homelab v3.0 Master Roadmap | v7.0 | Living Document — Update as phases complete_